...
class chatPDO
{
    ...
    function drowMessage(Chat $chat)
    {
                ...
                if ($this->logado->getId_usuario() == $chat->getIdRemetente()) {
                    echo "
                            ...
                            <div class='card-image'>
                                ...
                                <img class='materialboxed' src='" . $chat->getCaminhoMedia() . "'>
                ...
                if ($this->logado->getId_usuario() == $chat->getIdRemetente()) {
                    echo "
                            ...
                            <div style='width: 80%; margin-left: 20%'>
                                ...
                                <source src='" . $chat->getCaminhoMedia() . "' type='video/mp4'><source src=\"mov_bbb.flv\" type=\"video/flv\"> Browser Not Supporting
                                </video>
                                <input class='last_id' hidden value='" . $chat->getIdChat() . "'/>            
                                <span style='color: #5A5A5A; text-align: right; font-size: 9px; margin-left: 5px' >" . $hora->format('d/m H:i') . "</span>
    ...
    function refreshBodyChat()
    {
        ...
        while ($linha = $stmt->fetch()) {
            ...
            echo "  <li class='hoverable waves-effect openChat collection-item avatar' id_destinatario='" . $usuario->getId_usuario() . "'>
                                        <img src='". $pontos . $usuario->getFoto() . "' class='circle'>
